...
#loading data
library(tidyverse)
Daily_TRI <- read_rds("C:/Users/Richard/Documents/ECONOMIC MASTERS/Financial Econometrics/Assignments/index_return_comparison/data/Fin_Data_SA_US_NKY.rds")
...
# 2) Sharpe ratio for the equally weighted by country, cap-weighted index returns since 2017
```{r}
...
# 3)  Cumulative returns for the Financials indexes of the three countries
The JALSHAll outperforms the other two in the last few months
```{r}
...
# 4) JALSH index returns, by filtering the top 95% of Market Cap 
```{r}
