...
Cap_W_Month_Indx_Ret %>%
  ...
  ggsave("C:/Users/Richard/Documents/ECONOMIC MASTERS/Financial Econometrics/Assignments/index_return_comparison/bin/Cap_W_Month_Indx_Ret.png")
  dev.off()
...
ggplot(financial_sec_data) +
  ...
  ggsave("C:/Users/Richard/Documents/ECONOMIC MASTERS/Financial Econometrics/Assignments/index_return_comparison/bin/financial_sec_data.png")
  dev.off()
...
ggplot(JALSHAll_95_index_ret) +
  ...
  ggsave("C:/Users/Richard/Documents/ECONOMIC MASTERS/Financial Econometrics/Assignments/index_return_comparison/bin/JALSHAll_95_index_ret.png")
  dev.off()
